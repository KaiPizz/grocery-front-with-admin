...
export default defineConfig({
  ...
  projects: [
    {
      name: 'iphone-12',
      testIgnore: /(?:customer-account-p0|password-flows|google-auth|facebook-auth|resend-verification|graphql-bff-method)\.spec\.ts/,
      use: {
        ...devices['iPhone 12'],
      },
    },
    ...
    },
    {
      ...
      testMatch: /(?:customer-account-p0|password-flows|google-auth|facebook-auth|resend-verification|graphql-bff-method)\.spec\.ts/,
      use: {
