...
test('GraphQL proxy policy blocks direct and aliased token operations', () => {
  for (const query of [
    ...
    'mutation { customerGoogleLink(token: "oauth", nonce: "n", currentPassword: "p") { success } }',
    'mutation { customerFacebookLink(token: "oauth", currentPassword: "p") { success } }',
    'mutation { customerLoginProviderUnlink(provider: "google", currentPassword: "p") { success } }',
