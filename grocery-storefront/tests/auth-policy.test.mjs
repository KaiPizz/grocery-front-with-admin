...
test('GraphQL proxy policy blocks direct and aliased token operations', () => {
  for (const query of [
    ...
    'mutation { customerCredentialStepUp(currentPassword: "p") { success stepUpProof } }',
    'mutation { verifyProvider: customerCredentialStepUp(currentPassword: "p") { success stepUpProof } }',
    'mutation { customerGoogleLink(token: "oauth", nonce: "n", stepUpProof: "proof") { success } }',
    'mutation { customerFacebookLink(token: "oauth", stepUpProof: "proof") { success } }',
    'mutation { customerLoginProviderUnlink(provider: "google", stepUpProof: "proof") { success } }',
