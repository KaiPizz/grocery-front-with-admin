...
const DEFAULT_INPUT = 'docs/asiandeligo-catalog-metadata-batch6-decisions-20260722.json';
const DEFAULT_OUTPUT = 'docs/asiandeligo-catalog-metadata-batch6-remediation-20260722.md';
const DEFAULT_APPLY = 'docs/asiandeligo-catalog-metadata-batch6-apply-20260722.sql';
const DEFAULT_ROLLBACK = 'docs/asiandeligo-catalog-metadata-batch6-rollback-20260722.sql';
...
const PRODUCT_BACKUP_TABLE = 'asiandeligo_catalog_metadata_batch6_product_backup_20260722';
const AUDIT_TABLE = 'asiandeligo_catalog_metadata_batch6_audit_20260722';
const PRODUCT_BACKUP_RELATION = `public.${PRODUCT_BACKUP_TABLE}`;
const AUDIT_RELATION = `public.${AUDIT_TABLE}`;
const EXPECTED_DECISION_CONTENT_SHA256 = '400c99c69f9f0459f34fe618d204850344223fde895438142d5c2a6fca8d4303';
