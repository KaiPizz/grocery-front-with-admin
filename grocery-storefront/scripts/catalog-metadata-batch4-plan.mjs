...
const DEFAULT_INPUT = 'docs/asiandeligo-catalog-metadata-batch4-decisions-20260722.json';
const DEFAULT_OUTPUT = 'docs/asiandeligo-catalog-metadata-batch4-remediation-20260722.md';
const DEFAULT_APPLY = 'docs/asiandeligo-catalog-metadata-batch4-apply-20260722.sql';
const DEFAULT_ROLLBACK = 'docs/asiandeligo-catalog-metadata-batch4-rollback-20260722.sql';
...
const PRODUCT_BACKUP_TABLE = 'asiandeligo_catalog_metadata_batch4_product_backup_20260722';
const AUDIT_TABLE = 'asiandeligo_catalog_metadata_batch4_audit_20260722';
const PRODUCT_BACKUP_RELATION = `public.${PRODUCT_BACKUP_TABLE}`;
const AUDIT_RELATION = `public.${AUDIT_TABLE}`;
const EXPECTED_DECISION_CONTENT_SHA256 = 'cc7dc4f1729386db56ad1dc3aaaddf590c2978cfd8932bba4548eb76481641ec';
