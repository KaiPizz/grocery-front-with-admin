...
const DEFAULT_INPUT = 'docs/asiandeligo-catalog-metadata-batch7-decisions-20260722.json';
const DEFAULT_OUTPUT = 'docs/asiandeligo-catalog-metadata-batch7-remediation-20260722.md';
const DEFAULT_APPLY = 'docs/asiandeligo-catalog-metadata-batch7-apply-20260722.sql';
const DEFAULT_ROLLBACK = 'docs/asiandeligo-catalog-metadata-batch7-rollback-20260722.sql';
...
const PRODUCT_BACKUP_TABLE = 'asiandeligo_catalog_metadata_batch7_product_backup_20260722';
const AUDIT_TABLE = 'asiandeligo_catalog_metadata_batch7_audit_20260722';
const PRODUCT_BACKUP_RELATION = `public.${PRODUCT_BACKUP_TABLE}`;
const AUDIT_RELATION = `public.${AUDIT_TABLE}`;
const EXPECTED_DECISION_CONTENT_SHA256 = '7baca2cebb119f5ca286c06f9c14a1445e888d182a2fe13339f8aaaa5aa15e9f';
