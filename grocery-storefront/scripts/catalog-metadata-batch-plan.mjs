...
const DEFAULT_INPUT = 'docs/asiandeligo-catalog-metadata-batch25-decisions-20260722.json';
const DEFAULT_OUTPUT = 'docs/asiandeligo-catalog-metadata-batch25-remediation-20260722.md';
const DEFAULT_APPLY = 'docs/asiandeligo-catalog-metadata-batch25-apply-20260722.sql';
const DEFAULT_ROLLBACK = 'docs/asiandeligo-catalog-metadata-batch25-rollback-20260722.sql';

const EXPECTED_BATCH = 'asiandeligo-catalog-metadata-batch25-20260722-v1';
const EXPECTED_CHANNEL = 'asiandeligo';
const EXPECTED_SALON_ID = 'e73271a9-53e3-4a20-a02e-791726b452aa';
const PRODUCT_BACKUP_TABLE = 'asiandeligo_catalog_metadata_product_backup_20260722';
const AUDIT_TABLE = 'asiandeligo_catalog_metadata_audit_20260722';
const PRODUCT_BACKUP_RELATION = `public.${PRODUCT_BACKUP_TABLE}`;
const AUDIT_RELATION = `public.${AUDIT_TABLE}`;
const EXPECTED_DECISION_CONTENT_SHA256 = '264e7d94c2a9bd96d3d4ca7d1a9855489e51f5f14b816b310f422b26d82fcb58';
