...
const DEFAULT_INPUT = 'docs/asiandeligo-catalog-metadata-batch3-decisions-20260722.json';
const DEFAULT_OUTPUT = 'docs/asiandeligo-catalog-metadata-batch3-remediation-20260722.md';
const DEFAULT_APPLY = 'docs/asiandeligo-catalog-metadata-batch3-apply-20260722.sql';
const DEFAULT_ROLLBACK = 'docs/asiandeligo-catalog-metadata-batch3-rollback-20260722.sql';

const EXPECTED_BATCH = 'asiandeligo-catalog-metadata-batch3-20260722-v1';
const EXPECTED_CHANNEL = 'asiandeligo';
const EXPECTED_SALON_ID = 'e73271a9-53e3-4a20-a02e-791726b452aa';
const PRODUCT_BACKUP_TABLE = 'asiandeligo_catalog_metadata_batch3_product_backup_20260722';
const AUDIT_TABLE = 'asiandeligo_catalog_metadata_batch3_audit_20260722';
const PRODUCT_BACKUP_RELATION = `public.${PRODUCT_BACKUP_TABLE}`;
const AUDIT_RELATION = `public.${AUDIT_TABLE}`;
const EXPECTED_DECISION_CONTENT_SHA256 = '5bcd1c80b2931d70f5fa60e7a55f90be59584f35182d03cc2932c93fcf1a4b52';
